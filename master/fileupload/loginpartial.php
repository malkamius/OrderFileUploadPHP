<?php
    include_once("SignInManager.php");
 ?>
<ul class="navbar-nav">
<?php
...
?>
    <li class="nav-item">
        <a id="manage" class="nav-link text-dark" asp-area="Identity" href="/fileupload/Account/Manage/Index.php" title="Manage">Hello <?php print(htmlspecialchars($User->UserName));?>!</a>
    </li>
    <li class="nav-item">
